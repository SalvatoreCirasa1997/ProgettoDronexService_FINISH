...
<html>
    <head>
        ...
        <link rel='stylesheet' href= 'gestione_cancellazioni.css'> 
        <script src = "gestione_cancellazioni.js" defer></script>
    ...
    <body>
        <nav> 
            ...
            <h2 class='panel-title'>GESTIONE RICHIESTE DI CANCELLAZIONE</h2>

            <main>
                <section id='Richieste_ricevute'>
