...
if(isset($_POST["drone"])){
    ...
    mysqli_query($conn,"UPDATE drone_detail SET quantita_manutenzione = quantita_manutenzione-1,quantita_disponibili = quantita_disponibili+1 WHERE titolo = '$drone'");
    mysqli_close($conn);
}
